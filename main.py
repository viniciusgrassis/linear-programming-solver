...
from branch_and_bound.prepara_BaB import extrai_bases, prepara_restricoes, adiciona_restricoes, tem_float
    ...
    if a is not None:
        ...
        while len(pilha) != 0:
            ...
            if num_sol == 2 and invalido_alt is None:
                ...
                if melhor_tableau[0] is None or z_alt > melhor_tableau[0, -1]:
            ...
            if invalido is not None:
                ...
                pilha.append(Node(invalido, base[invalido], 2, maior))
                pilha.append(Node(invalido, base[invalido], 1, menor))
